...
<template>
  <div>
    ...
    <p>
      ...
      die Verarbeitung ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und &sect; 25
    ...
    <OnyxHeadline is="h2">3. Allgemeine Hinweise und Pflichtinformationen</OnyxHeadline>
    ...
    <OnyxHeadline is="h3">Widerruf Ihrer Einwilligung zur Datenverarbeitung</OnyxHeadline>
    <p>
    ...
    <OnyxHeadline is="h3">Beschwerderecht bei der zuständigen Aufsichtsbehörde</OnyxHeadline>
    <p>
    ...
    <OnyxHeadline is="h3">Recht auf Einschränkung der Verarbeitung</OnyxHeadline>
    <p>
    ...
    <OnyxHeadline is="h3">Anfrage per E-Mail, Telefon oder Telefax</OnyxHeadline>
    <p>
